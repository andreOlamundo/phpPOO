...
<body>
    <pre>
    <?php    
    require_once '../Controller/superClassPessoa.php';
    require_once '../Controller/childrenClassAluno.php';
    require_once '../Controller/childrenClassProfessor.php';
    require_once '../Controller/childrenClassFuncionario.php';
